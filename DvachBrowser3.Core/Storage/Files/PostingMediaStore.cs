...
namespace DvachBrowser3.Storage.Files
{
    ...
    public class PostingMediaStore : FolderStorage, IPostingMediaStore
    {
        ...
        public PostingMediaStore(IServiceProvider services, string folderName, ulong maxCacheSize, ulong normalCacheSize, string cacheDescription) : base(services, folderName, maxCacheSize, normalCacheSize, cacheDescription)
        {
        }
